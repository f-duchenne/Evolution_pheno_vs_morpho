...
dat=fread(paste0("data/empirical/outputs_simulations/results_for_each_individual_simulations/ueq_",liste$site[jj],"_",tr,"_",ess,".csv"))
nbsp_a=liste$na[jj]
nbsp_p=liste$np[jj]
...
path_folder="/home/duchenne/pheno" #run on a cluster
setwd(dir=path_folder)
